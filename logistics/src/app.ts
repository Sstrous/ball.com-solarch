...
setTimeout(async () => {
  ...
  config.rabbitmq.queue = 'ball-com.logistics';
  config.mongodb.read = 'mongodb://mongo-logistics:27017/logistics-read';
  config.mongodb.write = 'mongodb://mongo-logistics:27017/logistics-write';
